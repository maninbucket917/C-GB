## The following is a list of ROMS which have been tested, as well as their compatibility status.

### ✓ - The ROM functions as intended with no noticable problems. 

### ⚠ - The ROM functions mostly as intended, with minor bugs or graphical glitches.

### ✗ - The ROM does not function or functions poorly.

| Title | Region | Compatibile? | Notes |
|:-----:|:------:|:------------:|:-----:|
| Alleyway | World | ✓ | |
| Amida | Japan | ✓ | |
